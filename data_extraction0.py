...
# The dataset A.txt is split into _train.txt (the dataset that will be 
# used to create the user ranking) and _test.txt. The split is 80/20, 
...
def split_graph_dataset(file_type, split_ratio=0.8):
    ...
    train_file = f"./out/{file_type}_train.txt"
    test_file = f"./out/{file_type}_test.txt"
    train_labels_file = f"./out/{file_type}_graph_labels_train.npy"
    test_labels_file = f"./out/{file_type}_graph_labels_test.npy"
    train_node_ids_file = f"./out/{file_type}_node_graph_id_train.npy"
    #test_node_ids_file = f"./out/{file_type}_node_graph_id_test.npy"
    train_news_list_file = f"./out/{file_type}_news_list_train.txt"
    test_news_list_file = f"./out/{file_type}_news_list_test.txt"
    ...
    print(f"INFO: Correctly splitted the dataset '{file_type}'")
