...
def user_news_stats(file_type: str):
    id_mapping_file = f"./{file_type}/{file_type[:3]}_id_twitter_mapping.pkl"

    news_user_graph_file = f"./out/{file_type}_train.txt"
    news_user_mapping_file = f"./out/{file_type}_news_user_mapping.csv"
    ...
    print(f"\nINFO: User statistics with centrality measures for '{file_type}' correctly calculated")
